...
const hr = {
  ...
  businessInfo: {
    ...
    serviceOptions: [
      ...
      { value: "cleaning", label: "Dubinsko čišćenje" },
  ...
  services: {
    ...
    items: {
      ...
      cleaning: {
        ...
        description: "Temeljito čišćenje (idealno za smjene gostiju).",
        image: "/images/Cleaning.png",
        icon: "Clock",
        features: ["Dubinsko čišćenje", "Kupaonice i kuhinje", "Spremno za goste"],
      },
